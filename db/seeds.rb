...
e1 = Exercise.create(title: "situp", description: "Lie on back and crunch forward until entire back lifts from ground", duration: "0.0416666666666667", video: "https://www.youtube.com/watch?v=1fbU_MkV7NE")
...
e9 = Exercise.create(title: "Levers", description: "Hang from pull up bar pull body to horizontal position, hold for 1-5 seconds, lower and repeat", duration: "0.0416666666666667", video: "", )
e10 = Exercise.create(title: "Windshield Wipers", description: "Hang from pull up bar, pull body into lever position, create L-sit position, move feet from left to right in wind sheild wiper motion", duration: "0.0416666666666667", video: "", )
e11 = Exercise.create(title: "Knee to elbow twist on bar", description: "Hang from pull up bar, touch right elbow with left knee, switch sides and repeat for duration", duration: "0.0416666666666667", video: "", )
e12 = Exercise.create(title: "Mountain Climbers", description: "Keep body in plank position, touch right elbow with right knee, twist to touch other knee. Then repeat for other side. Continue to rotate sides for duration", duration: "0.0416666666666667", video: "", )
e13 = Exercise.create(title: "Weighted sit ups 30lbs", description: "Sit ups with feet secured. 30lbs or alternate weight across shoulders, perform max reps under control in duration", duration: "0.0416666666666667", video: "", )
e14 = Exercise.create(title: "Russian Twist with 30 lbs", description: "Sit with feet off ground. Rotate weight from side to side", duration: "0.0416666666666667", video: "", )
e15 = Exercise.create(title: "Soft Toes", description: "Hang from bar and lightly touch toes on targets with only climbing shoes", duration: "0.0416666666666667", video: "", )
e16 = Exercise.create(title: "Knee Raises to elbow", description: "Hang from bar and touch knees to elbows, when too tired raise knees to waist height", duration: "0.0416666666666667", video: "", )
e17 = Exercise.create(title: "L - Sits on bar", description: "Hang from bar and bring legs to horizonal position, repeat for duration", duration: "0.0416666666666667", video: "", )
e18 = Exercise.create(title: "Low knee raises fast", description: "Hang from bar and rapidly raise knees and repeat motion for duration", duration: "0.0416666666666667", video: "", )
e19 = Exercise.create(title: "Knee to toe touch on back", description: "Lie on back and touch opposite toe with opposite hand, repeat on each side for duration", duration: "0.0416666666666667", video: "", )
e20 = Exercise.create(title: "Plank High Steps", description: "Lie in plank position on elbows, bring knee outside of shoulder, repeat on each side for duration", duration: "0.0416666666666667", video: "", )
e21 = Exercise.create(title: "Hold Boat for 1 min", description: "Sit on pelvis, keep body suspended in V position", duration: "0.0416666666666667", video: "", )
e22 = Exercise.create(title: "Bicycle on bar", description: "Hang from bar and pull into lever position and bicycle feet for duration", duration: "0.0416666666666667", video: "", )
e23 = Exercise.create(title: "1 arm plank on each side", description: "Opposite foot and opposite hand on ground for 30 seconds on each side", duration: "0.0416666666666667", video: "", )
e24 = Exercise.create(title: "ab wheel from knees", description: "Use ab wheel from knees for duration", duration: "0.0416666666666667", video: "", )
e25 = Exercise.create(title: "ab wheel from toes", description: "Use ab wheel from toes for duration", duration: "0.0416666666666667", video: "", )
e26 = Exercise.create(title: "proper diet", description: "Find a diet that you'll be excited about. Try that new diet until and decide if it works with your lifestyle. Perhaps making some lifestyle shifts might be necessary to find the time to eat well. Try searching \"diet for _____ (rock climbing, running, etc)\" Don't get sucked into advertising schemes or the idea that there is a quick win. To get the results you're looking for (weight loss?) then you'll have to follow the golden rule: If more calories are burned than are consumed, weight goes down. Vice versa, and weight goes up.", duration: "0.0416666666666667", video: "", )
